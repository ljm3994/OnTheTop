...
EnemyBullet::EnemyBullet(D3DXVECTOR2 Pos, float BulletSize, float BulletSpeed, float FireSpeed, float Angle, float RotateAngle, FIRE_TYPE Type)
...
void EnemyBullet::SetPlayerPos(D3DXVECTOR2 * pos)
{
	m_PlayerPos = pos;
}
...
void EnemyBullet::BulletSetting(D3DXVECTOR2 Pos, float BulletSize, float BulletSpeed, float FireSpeed, float Angle, float RotateAngle, FIRE_TYPE Type)
{
	SetSize(BulletSize);
	SetPos(Pos);
